          ...
          <div className="row g-0 text-center m-5">
            ...
            <div className="col-md-8">
              <div className="card-body ">
                <h2 className="card-title display-4">{detalleNave.name} </h2>
            ...
            <div className="row justify-content-center">
              <div className="col">
                ...
                <p className="text-bl">{detalleNave.name}</p>
              </div>

              <div className="col">
                <p className="fw-bold mb-0">Model:</p>
                <p className="text-bl">{detalleNave.model}</p>
              </div>

              <div className="col">
                <p className="fw-bold mb-0">Manufacturer:</p>
                <p className="text-bl">{detalleNave.manufacturer}</p>
              </div>

              <div className="col">
                <p className="fw-bold mb-0">Length:</p>
                <p className="text-bl">{detalleNave.length}</p>
              </div>

              <div className="col">
                <p className="fw-bold mb-0">Crew:</p>
                <p className="text-bl">{detalleNave.crew}</p>
              </div>

              <div className="col">
                <p className="fw-bold mb-0">Passengers:</p>
                <p className="text-bl">{detalleNave.passengers}</p>
              </div>
